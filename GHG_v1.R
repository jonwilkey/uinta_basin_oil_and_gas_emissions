...
# Script Info
#-------------------------------------------------------------------------------
# GHG_v1.R (Greenhouse gas emissions)
# Version 1
# 05/06/14
# Jon Wilkey
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# --- Version 1 ---
# 1. Loads *.rda files, determines PDF & CDF for each stage of oil and gas
...
pdf(file.path(plot_root, "GHG_v1 MC Simulation Results.pdf"))
...
plot(t, EFquant[,1],
     ...
     main = "GHG MC Simulation Results")
...
plot(t, PFquant[,1],
     ...
     main = "CH4 MC Simulation Results")
...
#-------------------------------------------------------------------------------
# Save plots to PDF file
pdf(file.path(plot_root, "GHG_v1 Results.pdf"))

# Total GHG Emissions from Gas Drilling -> Trans.
...
plot(pdf.trs,
     xlab = "GHG Emissions (1e3 kg / MCF Gas)",
     ylim = c(0, 500),
     main = "GHG Emissions from Transmission & Distribution")
rug(jitter(ef.trs))
lines(pdf.trs$x,
