...
calc_E_wc <- function(fuel, red, wc.EF) {
  ...
  E.wc <- data.frame(em.wc.pm10 = fuel * wc.EF$pm10 * (1 - red) / 2000,
                     em.wc.pm25 = fuel * wc.EF$pm25 * (1 - red) / 2000,
                     em.wc.nox  = fuel * wc.EF$nox  * (1 - red) / 2000,
                     em.wc.voc  = fuel * wc.EF$voc  * (1 - red) / 2000,
                     em.wc.co   = fuel * wc.EF$co   * (1 - red) / 2000)
