...
opt$oil.fpp.init <- 71.03 #52.14 2014-12-01 values
opt$gas.fpp.init <-  4.85 # 3.39
...
opt$drilled.init <- 43 # 54 (2014-12-01 value)
...
opt$affix  <-     " -epaper -v2.pdf" # Any text here will be added to the end " " " "...
