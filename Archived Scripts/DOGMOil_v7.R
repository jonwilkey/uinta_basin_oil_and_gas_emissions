...
# Model 9: Basin aggregate with only gas prices
...
#                compare_train$oil_price + compare_train$oil_price:compare_train$oil_lag_2 +
#                compare_train$gas_price + compare_train$gas_price:compare_train$gas_lag_2 +
...
legend("topright", c("Actual", "Model 8"),
