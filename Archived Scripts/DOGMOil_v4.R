...
# Plot output
plot(compare$drill_date, compare$wells_drilled, type = "l", lty = 1, lwd = 2, xlab = "Date", ylab = "Number of Wells Drilled",
...
# Oil price plot
plot(bwInfAd$drill_date, bwInfAd$oil_price, type = "l", lty = 1, xlab = "Date", ylab = "Oil Price (Dec 2012 $ / bbl)",
