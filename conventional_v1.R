#-------------------------------------------------------------------------------
# conventional_v1.R (Conventional Oil and Gas Model)
# Version 1
# 01/14/14
# Jon Wilkey
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Save plots to PDF
pdf(file = paste("conventional_v1 Results.pdf"))
...
legend("topleft",
       ...
       lty = c(1,1),
       col = c("blue", "black"))
# Plot of Predicted Oil Production
...
legend("topleft",
       ...
       lty = c(1,1),
       col = c("black", "blue"))
# Plot of Predicted Gas Production
